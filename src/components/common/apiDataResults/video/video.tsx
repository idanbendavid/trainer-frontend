...
function Video(props) {
    ...
    return (
        <div className='video-component'>
            {videoToShow.url &&
                <>
                    <iframe className='iframe-video' src={videoToShow.url} title={videoToShow.title} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
